...
# What's New
* `June, 2023` We have released a LLM [KnowLM(智析)](https://github.com/zjunlp/KnowLM) for knowledge extraction, and provided more LLMs (e.g., ChatGLM, LLaMA-series) support for [DeepKE-LLM](https://github.com/zjunlp/DeepKE/tree/main/example/llm).
