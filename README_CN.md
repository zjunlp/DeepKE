...
* `2023年6月` 为[DeepKE-LLM](https://github.com/zjunlp/DeepKE/tree/main/example/llm)新增多个大模型(如ChatGLM, LLaMA-series)支持和提供抽取优化的大模型[CaMA](https://github.com/zjunlp/CaMA)。
