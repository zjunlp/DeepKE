...
DeepKE 是一个开源的知识图谱抽取与构建工具，支持<b>低资源、长篇章</b>的知识抽取工具，可以基于<b>PyTorch</b>实现<b>命名实体识别</b>、<b>关系抽取</b>和<b>属性抽取</b>功能。<br>同时为初学者提供了详尽的[文档](https://zjunlp.github.io/DeepKE/)，[Google Colab教程](https://colab.research.google.com/drive/1vS8YJhJltzw3hpJczPt24O0Azcs3ZpRi?usp=sharing)和[在线演示](http://deepke.zjukg.cn/CN/index.html)。
...
- 发布模型[DeepKE-cnschema(RE)](https://github.com/zjunlp/DeepKE/blob/main/example/re/standard/README.md)和[DeepKE-cnschema(NER)](https://github.com/zjunlp/DeepKE/blob/main/example/ner/standard/README.md)模型。
## 2022年1月
...
6. 推荐使用`python setup.py install`方式安装*DeepKE*
