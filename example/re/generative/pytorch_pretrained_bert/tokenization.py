...
def load_vocab(vocab_file):
    ...
    extra_map['[unused19]'] = '[S2S_SEQ]'
    extra_map['[unused20]'] = '->'
    extra_map['[unused21]'] = '[True]'
    extra_map['[unused22]'] = '[False]'
...
class BertTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, max_len=None, never_split=("[UNK]", "[SEP]", "[X_SEP]", "[PAD]", "[CLS]", "[MASK]","[S2S_SEQ]","->","[True]","[False]")):
