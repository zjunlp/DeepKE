...
with codecs.open('source_test_seo.txt', 'w', encoding='utf-8') as f:
...
# with codecs.open('all_date_target.txt', 'w', encoding='utf-8') as f:
...
# with codecs.open('all_date_source.txt', 'w', encoding='utf-8') as f:
#     for i in tqdm(all_data):
#         f.write(i['text']+'\n')
