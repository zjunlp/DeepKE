# Fine-tuning ChatGLM to complete InstructKGC-CCKS2023 Evaluation of Instruction-based Knowledge Graph Construction

<p align="left">
    <b> English | <a href="https://github.com/zjunlp/DeepKE/blob/main/example/llm/InstructKGC/chatglm/README.md">简体中文</a> </b>
</p>
...
```bash
CUDA_VISIBLE_DEVICES=0,1,2,3 deepspeed finetuning_PT.py --num_train_epochs 5 --train_batch_size 2 --lora_r 8
```
