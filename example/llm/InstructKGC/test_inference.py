...
from transformers import GenerationConfig, AutoModel, AutoTokenizer, LlamaForCausalLM, LlamaTokenizer
...
def main(
    ...
    tokenizer = MyTokenizer.from_pretrained(base_model, trust_remote_code=True,)
