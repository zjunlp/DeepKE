...
<h1 align="center">
    <p>A Large Language Model Based Knowledge Extraction Toolkit<br>DeepKE-LLM</p>
</h1>


- [Models](#models)
  - [CaMA](#cama)
    - [Case 1: LoRA Fine-tuning of CaMA for CCKS2023 Instruction-Driven KG Construction](#case-1-lora-fine-tuning-of-cama-for-ccks2023-instruction-driven-kg-construction-english--chinese)
  - [LLaMA](#llama)
  ...
  - [GPT-Series](#gpt-series)
    ...
    - [Case 4: Unleash the Power of Large Language Models for Few-shot Relation Extraction](#case-4-unleash-the-power-of-large-language-models-for-few-shot-relation-extraction-english--chinese)
    - [Case 5: CodeKGC-Code Language Models for KG Construction](#case-5-codekgc-code-language-models-for-kg-construction-english--chinese)
- [Methods](#methods)
...
### Case 1: LoRA Fine-tuning of CaMA for CCKS2023 Instruction-Driven KG Construction [English](./InstructKGC/README.md) | [Chinese](./InstructKGC/README_CN.md)
