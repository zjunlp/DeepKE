...
class EEAConverter:
    def __init__(self, language="zh", NAN="", prefix="", template_path="configs/eea_template.json"):
    ...
    def convert(self, record, rand1, rand2, s_schema1, s_schema2=""):
        ...
        sinstruct = self.event_template[str(rand1)].format(s_format=output_template[0], s_schema1=s_schema1, s_schema2=s_schema2)
        return sinstruct, output_text

    def convert_open(self, record, rand1, rand2, s_schema1, s_schema2=""):
        output_template = self.event_int_out_format[rand2]
        output_text = output_template[1](record)
        sinstruct = self.event_open_template[str(rand1)].format(s_format=output_template[0], s_schema1=s_schema1, s_schema2=s_schema2)
        return sinstruct, output_text
