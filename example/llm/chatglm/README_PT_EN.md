...
<p align="left">
    <b> English | <a href="https://github.com/zjunlp/DeepKE/blob/main/example/llm/chatglm/README_PT.md">简体中文</a> </b>
</p>
...
You can use the trained PT model to predict the output on the competition test set using the following script:
