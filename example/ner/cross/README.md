...
Illustration of Collaborative Domain-Prefix Tuning for cross-domain NER (CP-NER) based on text-to-text generative PLMs (Details in paper [https://arxiv.org/abs/2301.10410](https://arxiv.org/abs/2301.10410)).
